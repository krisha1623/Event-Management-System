...
$sql = "INSERT INTO admlogin (username, password) VALUES ('$username', '$hashedPassword')";
...
<body>
    ...
    <div class="container">
        ...
        <h1>Welcome Admin!</h1>
        <a href="adddata.php" class="add-event-button">Add Data</a>
        ...
        <br>
        <a href="studentlogin.php" class="add-event-button">Logout</a></button>
    </div>
